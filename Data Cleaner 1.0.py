...
class cleaner:
    ...
    def create_fun_buttons(self):
        self.b1 = tk.Button(self.window, width=10, height=1, bg = "#76b5c5" ,text="Uppercase", command=lambda: self.uppercase())
        self.b1.place(x=55, y=160)
        self.b2 = tk.Button(self.window, width=10, height=1, bg = "#76b5c5" ,text="Lowercase", command=lambda: self.lowercase())
        self.b2.place(x=185, y=160)
        self.b3 = tk.Button(self.window, width=10, height=1, bg = "#76b5c5" ,text="limatize", command=lambda: self.limatizatiom())
        self.b3.place(x=335, y=160)
        self.b4 = tk.Button(self.window, width=10, height=1, bg = "#76b5c5" ,text="steming", command=lambda: self.steming())
        self.b4.place(x=470, y=160)
        self.b5 = tk.Button(self.window, width=10, height=1, bg = "#1e81b0" ,text="Edit", command=lambda: self.edit())
        self.b5.place(x=55, y=230)
        self.b6 = tk.Button(self.window, width=10, height=1, bg = "#1e81b0" ,text="Find", command=lambda: self.find())
        self.b6.place(x=185, y=230)
        self.b7 = tk.Button(self.window, width=10, height=1, bg = "#1e81b0" ,text="Convert to PDF", command=lambda: self.pdf())
        self.b7.place(x=335, y=230)
        self.b8 = tk.Button(self.window, width=10, height=1, bg = "#1e81b0" ,text="Count", command=lambda: self.count())
        self.b8.place(x=470, y=230)
        self.browse = tk.Button(self.window, width=10, height=1, bg = "#abdbe3" ,text="Browse", command=lambda: self.open_file())
    ...
    def run(self):
        self.changeOnHover(self.b1, "#84C69B", "#76b5c5")
        self.changeOnHover(self.b2, "#84C69B", "#76b5c5")
        self.changeOnHover(self.b3, "#84C69B", "#76b5c5")
        self.changeOnHover(self.b4, "#84C69B", "#76b5c5")
        self.changeOnHover(self.b5, "#84C69B", "#1e81b0")
        self.changeOnHover(self.b6, "#84C69B", "#1e81b0")
        self.changeOnHover(self.b7, "#84C69B", "#1e81b0")
        self.changeOnHover(self.b8, "#84C69B", "#1e81b0")
        self.changeOnHover(self.browse, "#84C69B", "#abdbe3")
